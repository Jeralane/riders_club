...
class ChaptersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post chapters_url, params: { chapter: { area: @chapter.area, club_id: @chapter.club_id, main: @chapter.main } }
    end
  ...
  test "should update chapter" do
    patch chapter_url(@chapter), params: { chapter: { area: @chapter.area, club_id: @chapter.club_id, main: @chapter.main } }
